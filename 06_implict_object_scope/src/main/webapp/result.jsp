...
<body>
	...
	<!-- 
		...
		// 응답을 받은 브라우저에게 우리가 전달한
		// location 페이지로 새롭게 요청을 전달하라고 응답.
		
		2. request 의 RequestDispatcher를 이용한 forward 방법
		// 요청을 처리하고 나서 응답할 jsp 페이지를 변경하는 방법
		
		
	 -->
	 <a href="response?id=rlagudtn">response send redirect</a>
	 <hr/>
	 <a href="dispatcher?id=rlagudtn">dispatcher forward</a>
</body>
</html>